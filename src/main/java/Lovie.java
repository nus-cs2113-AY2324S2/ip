            ...
            if (input.equals("bye")) {
                ...
                if (input.equals("list")) {
                    ...
                    while (counter < taskList.size()) {
                        ...
                        System.out.println("        " + listNumber + ". " + "[" + taskList.get(counter).getStatusIcon() + "] " + taskList.get(counter).description + "\n\n");
                        counter += 1; 
                    }
                    System.out.println("        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n");
                }
                    ...
                    if (input.contains("unmark")) {
                        ...
                        if (taskNumber >= taskList.size()) {
                            System.out.println("\n\n");
                            System.out.println("        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n");
                            System.out.println("        Sorry, there is no record of a task number " + input.split(" ")[1].toString() + "\n");
                            System.out.println("        Can I help you with anything else?\n\n"); 
                            System.out.println("        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n"); 
                        }
                        else {
                            Task selectedTask = taskList.get(taskNumber); 
                            selectedTask.markAsUndone();
                            System.out.println("\n\n");
                            System.out.println("        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n");
                            System.out.println("        Okay, no worries. I've unmarked this task for you: \n"); 
                            System.out.println("            [" + selectedTask.getStatusIcon() + "] " + selectedTask.description + "\n"); 
