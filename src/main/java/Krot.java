...
/**
 * Krot class which is the class for Krot, our chatbot.
 *
 * @param ui UI class responsible for generating responses.
 * @param parser Parser class responsible for managing user inputs.
 * @param storage Storage class responsible for reading and writing.
 * @param taskList TaskList class responsible for creating a list of tasks.
 */
public class Krot {
    ...
    /**
     * Calls and handles the respective functions based off commands given by user.
     *
     * @param key Command initializer.
     * @param line Line of input generated by user.
     */
    ...
    /** Runs the chatbot until user logs off */
    public void run() {
        // Runs the bot
        String line;
        ui.printSeparator();
