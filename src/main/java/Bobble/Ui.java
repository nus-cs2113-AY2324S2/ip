...
public class Ui {
    ...
    public void printEmptyFieldErrorMessage(String command) {
        System.out.println(LINE_WRAP +
                "OOPS!! One or more fields of " + command + " cannot be empty.\n" + LINE_WRAP);
    }
    ...
    public void printMarkResponse(String task) {
        System.out.println(LINE_WRAP + "Nice! I've marked this task as done:\n  " + task + "\n" + LINE_WRAP);
    }
    ...
    public void printUnmarkResponse(Task task) {
        System.out.println(LINE_WRAP + "OK, I've marked this task as not done yet:\n  " + task.toString() + "\n" +
                LINE_WRAP);
    }
