    ...
    public static void runCommandUntilExit(String line, File file, Scanner in, ArrayList<Task> todos) {
        ...
        while (!(line.toUpperCase().contains("BYE"))) {
            ...
            if (line.equalsIgnoreCase("LIST")) {
                runList(todos, todosCount);
            } else if (command.equalsIgnoreCase("MARK")) {
                runMark(file, todos, lineWords, todosCount);
            } else if (command.equalsIgnoreCase("UNMARK")) {
                runUnmark(file, todos, lineWords, todosCount);
            } else if (command.equalsIgnoreCase("DELETE")) {
                runDelete(file, todos, lineWords, todosCount);
            } else {
                runAdd(line, file, todos, command, todosCount);
            }
