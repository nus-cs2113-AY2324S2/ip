...
public abstract class Command {
     ...
     * @throws IncorrectIndexException If MarkUnmarkCommand or DeleteCommand provided with non-numerical index or with
     * numerical index beyond task arraylist size.
     ...
     * */
    public abstract void perform () throws IncorrectArgumentNumException, IncorrectIndexException,
